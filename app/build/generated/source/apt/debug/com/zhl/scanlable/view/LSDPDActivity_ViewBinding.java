...
public class LSDPDActivity_ViewBinding implements Unbinder {
  private LSDPDActivity target;
  ...
  @UiThread
  public LSDPDActivity_ViewBinding(LSDPDActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public LSDPDActivity_ViewBinding(final LSDPDActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    LSDPDActivity target = this.target;
