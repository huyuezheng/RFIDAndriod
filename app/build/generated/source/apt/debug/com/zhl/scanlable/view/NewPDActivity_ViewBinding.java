...
public class NewPDActivity_ViewBinding implements Unbinder {
  private NewPDActivity target;
  ...
  @UiThread
  public NewPDActivity_ViewBinding(NewPDActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public NewPDActivity_ViewBinding(final NewPDActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    NewPDActivity target = this.target;
